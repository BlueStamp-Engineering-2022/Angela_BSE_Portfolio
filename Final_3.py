...
def index_faces(bucket, key, collection_id, image_id=None, attributes=(), region="us-west-1"):
    ...
    "S3Object": {
                ...
                ExternalImageId="angelaqian2023",
        ...
        if len(response['FaceMatches']) == 0:
            ...
            for match in response['FaceMatches']:
                ...
                if 'Item' in face:
                    ...
                    if (guest=='Angela Qian' or guest == 'Mom' or guest == 'Dad'):
                        ser=serial.Serial('/dev/ttyACM0',9600,timeout=1)
...
def upload_image(FullName="Guest"):
        ...
        object = s31.Object('facebucketthing','image.jpeg')
        ret = object.put(Body=file,Metadata={'FullName':FullName})
        #print(ret)
        return
def send_email():
    fromaddr = "angelazqian@gmail.com"
    toaddr = "angelazqian@gmail.com"
    ...
    server.starttls()
    server.login(fromaddr, "lntpeieokywapfin")
    text = msg.as_string()
